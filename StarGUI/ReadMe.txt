================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet StarGUI
===============================================================================

L'Assistant Application a créé cette application StarGUI pour  
...
constituent votre application StarGUI.
...
d'autres 
    ...
    classe d'application CStarGUIApp.
...
Cette 
    icône est incluse par le fichier de ressource principal StarGUI.rc.
...
StarGUIDlg.h, StarGUIDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CStarGUIDlg.  Cette classe 
définit 
    le comportement de la boîte de dialogue principale de votre application.  Le 
modèle de boîte de dialogue se trouve 
    dans StarGUI.rc et peut être modifié dans Microsoft Visual 
C++.
...
(PCH) 
    nommé StarGUI.pch et un fichier de type précompilé nommé 
Stdafx.obj.
