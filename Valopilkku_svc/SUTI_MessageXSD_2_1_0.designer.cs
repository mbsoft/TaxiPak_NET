...
namespace SUTI_svc
{
        ...
        public virtual string Serialize(System.Text.Encoding encoding)
        {
            ...
            try
            {
                ...
                if (serializeResult.Contains("OrderCancellation") ||
                    ...
                    serializeResult.Contains("Not Operational") ||
                    serializeResult.Contains("OrderReject"))
                    serializeResult = serializeResult.Replace("<idVehicle />", "");
                if (serializeResult.Contains("PickupConfirmation") ||
                    serializeResult.Contains("Requested Location"))
                {
                    serializeResult = serializeResult.Replace("<geographicLocation lat=\"0\" long=\"0\" />", "");
                    serializeResult = serializeResult.Replace("<idAddressName />", "");
                    serializeResult = serializeResult.Replace("<idStreet />", "");
                    serializeResult = serializeResult.Replace("<idPostalCode />", "");
                    serializeResult = serializeResult.Replace("<idCommunity />", "");
                    serializeResult = serializeResult.Replace("<idCountry />", "");
                    serializeResult = serializeResult.Replace("<attributeAddress />", "");
                    serializeResult = serializeResult.Replace("<idMsg />", "");
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error with Serializer");
                return null;
            }
            finally
            {
    ...
    public enum timeTimeType
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlEnumAttribute("scheduledtime")]
        scheduledtime,
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlEnumAttribute("promisedtime")]
        promisedtime,
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "", IsNullable = false)]
    [XmlInclude(typeof(pickupConfirmation))]
