...
namespace SUTI_svc
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(LocationResponse));
        private string sSrc;
        private string sID;
        ...
        public LocationResponse(SUTI from, SUTIMsg msgFrom, string msgID, int msgCounter)
        {
            inSUTI = from;
            inSUTImsg = msgFrom;
            sID = msgID;
